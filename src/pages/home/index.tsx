...
export default function Home () {
    ...
    if (isMobile) {
        return (
            <MobileContainer>
                <MobileHeader/>
                <MobilePageContainer data-aos="fade-up" style={{paddingTop: '120px'}}>
                    <Text fontSize={30} bold={true} textAlign={'center'} lineHeight={'130%'}>
                        '나'의 2405일,<br/>
                        그 이상을 위한 검색
                    </Text>
                    <div css={css`
                    ...
                    <Text fontSize={12} textAlign={'center'} marginBottom={'10px'}>
                        일생의 2405일 동안 15000개의 생리대를 쓰는 우리.<br/>
                ...
                <MobilePageContainer  backgroundColor={'#F7FFF9'}>
                    <Text fontSize={20} textAlign={'center'} bold={true}>
                        무의미하던 성분표기<br/>
                        <Text fontSize={22} color={'#1ED05B'} bold={true}>해석</Text>해서 의미를 만듭니다
                    </Text>
                    <img alt={'랜딩 이미지'} src={ImageRending} style={{objectFit: 'contain', width: 'calc(100% - 40px', padding: '20px 0px'}}/>
                    <Text fontSize={12} textAlign={'center'} marginBottom={'10px'}>
                        읽기조차 힘든 성분표기,<br/>
                        우린 알 수 없었기에 마케팅에 휘둘렸고,<br/>
                        업체는 제품보다 마케팅에 집중합니다.
                    </Text>
                    <Text fontSize={12} textAlign={'center'} bold={true}>
                        우리가 알아야 시장이 변화합니다.<br/>
                        세잎이 해석하겠습니다.
                    </Text>
                </MobilePageContainer>
                <MobilePageContainer>
                    <Text fontSize={22} textAlign={'center'} bold={true}>
                        그래서 뭐가 좋은 생리대인데?<br/>
                        <Text fontSize={22} color={'#1ED05B'} bold={true}>세잎</Text>은 섣불리 추천하지 않습니다.
                    </Text>
                    <PlayerContainer>
                        <ReactPlayer 
                            width="100%"
                    ...
                    <Text fontSize={12} textAlign={'center'} marginBottom={'20px'}>
                        세잎의 목표는<br/>
                        투명하고 건강한 여성용품 생태계를 만드는 것
                    </Text>
                    <Text fontSize={12} textAlign={'center'} bold={true}>
                        이를 위해 답안지같은 추천이 아닌,<br/>
