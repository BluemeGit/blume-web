...
export default function Product() {
  ...
  useEffect(() => {
    ...
    data.data.materials.map((objs: MaterialObjectType) => {
      ...
      else if (objs.type === "접착제") objs.orderList = 3;
      else if (objs.type === "방수충") objs.orderList = 4;
    ...
    return (
      <Container>
        ...
        <ProductContainer>
          <ProductImage
            src={
              "https://kr.object.ncloudstorage.com/blume/" + data.data.imageUrl
            }
          />
        ...
        <Footer>
          ...
          {"\n"}
          2. 성분 해석 정보는 제품 구매를 위한 참고 정보이며, 법적 책임을 지지
          않습니다.
          {"\n"}
          3. 데이터의 오류가 있을 수 있습니다.
          {"\n"}제품 구매 전 제조판매업자가 표기한 전성분 표를 한 번 더
          확인하시길 권장합니다.{"\n"}
          4. 세잎의 성분 해석 정보를 허가 없이 상업적으로 활용할 경우, 법적
          조치를 받을 수 있습니다.{"\n"}
        </Footer>
        <div
          style={{
  ...
  return (
    ...
    >
      ...
      <FooterPC>
        ...
        2. 성분 해석 정보는 제품 구매를 위한 참고 정보이며, 법적 책임을 지지
        않습니다.{"\n"}
        3. 데이터의 오류가 있을 수 있습니다. 제품 구매 전 제조판매업자가 표기한
        전성분 표를 한 번 더 확인하시길 권장합니다.{"\n"}
        4. 세잎의 성분 해석 정보를 허가 없이 상업적으로 활용할 경우, 법적 조치를
        받을 수 있습니다.{"\n"}
        {"\n"}
        {"\n"}
        {"\n"}
